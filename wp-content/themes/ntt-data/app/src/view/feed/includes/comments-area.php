        ...
        <div class="comments">
            ...
            <div class="content">
                <div class="infoPub">
                    ...
                    <?php if ($user->id_user === $comment->id_user) :; ?>
                        <nav class="navPub">
                            <img id="threeDots" src="<?= get_stylesheet_directory_uri() . '/app/public\assets\img\icons/feed/three-dots.svg' ?>" alt="">
                            <div class="contentNav" <?php echo md5('id_comment') . '="' . $comment->id_comment . '"' ?> <?php echo md5('comment_id_user') . '="' . $comment->id_user . '"' ?><?php echo md5('id_user') . '="' . $user->id_user . '"' ?>>
